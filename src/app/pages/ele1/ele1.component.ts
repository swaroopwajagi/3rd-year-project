...
@Component({
  selector: 'app-ele1',
  templateUrl: './ele1.component.html',
  styleUrls: ['./ele1.component.css']
})
export class Ele1Component implements OnInit {
 ...
 uploadata(books:any){
    ...
    console.warn(books);
    this.add.ele1(books).subscribe((res)=>{
 ...
 ngOnInit(): void {
   this.display=this.add.getele1().subscribe(res=>{
     this.product = res;
