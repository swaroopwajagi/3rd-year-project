...
@Component({
  selector: 'app-dwm',
  templateUrl: './dwm.component.html',
  styleUrls: ['./dwm.component.css']
})
export class DwmComponent implements OnInit {
 ...
 uploadata(books:any){
    ...
    console.warn(books);
    this.add.dwm(books).subscribe((res)=>{
 ...
 ngOnInit(): void {
   this.display=this.add.getdwm().subscribe(res=>{
     this.product = res;
