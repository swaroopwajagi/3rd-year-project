...
@Component({
  selector: 'app-ele4',
  templateUrl: './ele4.component.html',
  styleUrls: ['./ele4.component.css']
})
export class Ele4Component implements OnInit {
 ...
 uploadata(books:any){
    ...
    console.warn(books);
    this.add.ele4(books).subscribe((res)=>{
 ...
 ngOnInit(): void {
   this.display=this.add.getele4().subscribe(res=>{
     this.product = res;
