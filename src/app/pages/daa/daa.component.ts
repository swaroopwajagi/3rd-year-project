...
@Component({
  selector: 'app-daa',
  templateUrl: './daa.component.html',
  styleUrls: ['./daa.component.css']
})
export class DaaComponent implements OnInit {
 ...
 uploadata(books:any){
    ...
    console.warn(books);
    this.add.daa(books).subscribe((res)=>{
 ...
 ngOnInit(): void {
   this.display=this.add.getdaa().subscribe(res=>{
     this.product = res;
