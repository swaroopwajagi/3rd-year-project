...
@Component({
  selector: 'app-ele2',
  templateUrl: './ele2.component.html',
  styleUrls: ['./ele2.component.css']
})
export class Ele2Component implements OnInit {
 ...
 uploadata(books:any){
    ...
    console.warn(books);
    this.add.ele2(books).subscribe((res)=>{
 ...
 ngOnInit(): void {
   this.display=this.add.getele2().subscribe(res=>{
     this.product = res;
