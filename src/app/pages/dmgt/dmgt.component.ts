...
@Component({
  selector: 'app-dmgt',
  templateUrl: './dmgt.component.html',
  styleUrls: ['./dmgt.component.css']
})
export class DmgtComponent implements OnInit {
  a:any;
  options:any;
  res:any;
  display:any;
 ...
 uploadata(books:any){
    ...
    console.warn(books);
    this.add.dmgt(books).subscribe((res)=>{
 ...
 ngOnInit(): void {
   this.display=this.add.getdmgt().subscribe(res=>{
     this.product = res;
