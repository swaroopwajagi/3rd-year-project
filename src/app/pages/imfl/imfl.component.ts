...
@Component({
  selector: 'app-imfl',
  templateUrl: './imfl.component.html',
  styleUrls: ['./imfl.component.css']
})
export class ImflComponent implements OnInit {
 ...
 uploadata(books:any){
    ...
    console.warn(books);
    this.add.imfl(books).subscribe((res)=>{
 ...
 ngOnInit(): void {
   this.display=this.add.getimfl().subscribe(res=>{
     this.product = res;
