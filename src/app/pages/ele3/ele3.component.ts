...
@Component({
  selector: 'app-ele3',
  templateUrl: './ele3.component.html',
  styleUrls: ['./ele3.component.css']
})
export class Ele3Component implements OnInit {
 ...
 uploadata(books:any){
    ...
    console.warn(books);
    this.add.ele3(books).subscribe((res)=>{
 ...
 ngOnInit(): void {
   this.display=this.add.getele3().subscribe(res=>{
     this.product = res;
